                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="breadcrumb-main">
                                <h4 class="text-capitalize breadcrumb-title">Editing clients Datas
</h4>
...
<div class="col-lg-12">
                    ...
                    <div class="layout-button mt-0">
                        <a href="{{ route('clients.index') }}" class="btn btn-default btn-squared border-normal bg-normal px-10">Cancel</a>
